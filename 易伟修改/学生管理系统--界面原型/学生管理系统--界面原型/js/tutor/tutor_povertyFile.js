...
function manually() {
	...
	if(iMsg === "" || iMsg === "undefined" || iMsg === undefined) {
		...
		oTeacherTr1Td.appendChild(document.createTextNode("建档信息录入表"));
